...
public class OrderDAO {
    ...
    public static ArrayList<OrderDTO> getOrdersByUserId(Integer userId) {
        ...
        try {
            ...
            String GET_ORDERS = "SELECT id, person_id, address, phone, status, created_date, total FROM person_order WHERE person_id = ? ORDER BY id DESC";
    ...
    public static Order getOrderById(int orderId, int userId) {
        ...
        try {
            ...
            String SQL_CHECK_ORDER_OWNER = "SELECT * FROM person_order WHERE id = ? AND person_id = ?";
            ...
            String SQL_GET_ORDER_ITEMS = "SELECT img_url, product.name, order_item.quantity, order_item.price " +
            ...
            order = new Order();
            String SQL_GET_ORDER = "SELECT address, phone, status, total, created_date FROM person_order WHERE id = ?";
